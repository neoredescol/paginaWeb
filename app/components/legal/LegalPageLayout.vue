...
.legal-document { width: min(100%,54rem); animation: legal-reveal .65s .12s ease both; }
...
.legal-section p,.legal-section li { color: rgba(242,244,247,.76); font: 400 clamp(.95rem,1.15vw,1.08rem)/1.8 var(--font-body); }
